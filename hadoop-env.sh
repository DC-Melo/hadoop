...
export JAVA_HOME=/opt/4T/java/jdk1.8.0_231
export HADOOP_PID_DIR=/opt/4T/hadoop/hadoop-3.3.0/hadoop_data/tmp/pids
export HDFS_NAMENODE_USER=test
export HDFS_DATANODE_USER=test
export HDFS_SECONDARYNAMENODE_USER=test
export YARN_RESOURCEMANAGER_USER=test
